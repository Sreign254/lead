...
CREATE TABLE `lead` (
  ...
  `profileimg` varchar(266) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(0, 'mama', 'ma@gmail.com', '$2y$10$anPPLjEK0M3CkGAw6.g4NO/h92H3QICUeos/2cU.O9Bq/vrb5kHBe', NULL, 'pexels-mikhail-nilov-6893331.jpg');
...
(0, 'unpaid bills 003.xlsx', '1706221655455396unpaid bills 003.xlsx');
